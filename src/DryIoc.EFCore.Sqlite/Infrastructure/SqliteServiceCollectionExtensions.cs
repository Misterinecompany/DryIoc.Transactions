...
using DryIoc.EFCore.Sqlite.Metadata.Conventions;
...
using SqliteRelationalConnection = DryIoc.EFCore.Sqlite.Storage.Internal.SqliteRelationalConnection;

// ReSharper disable once CheckNamespace
namespace DryIoc.EFCore.Sqlite.Infrastructure
{
    /// <summary>
