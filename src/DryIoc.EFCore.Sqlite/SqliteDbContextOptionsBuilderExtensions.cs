...
using DryIoc.EFCore.Sqlite.Infrastructure.Internal;
using JetBrains.Annotations;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Diagnostics;
using Microsoft.EntityFrameworkCore.Infrastructure;
using SqliteDbContextOptionsBuilder = DryIoc.EFCore.Sqlite.Infrastructure.SqliteDbContextOptionsBuilder;

namespace DryIoc.EFCore.Sqlite
{
    /// <summary>
    ...
    public static class SqliteDbContextOptionsBuilderExtensions
    {
        ...
        public static DbContextOptionsBuilder UseSqliteWithIgnoredAmbientTransaction(
        ...
        /// <param name="sqliteOptionsAction">An optional action to allow additional SQLite specific configuration.</param>
        /// <returns> The options builder so that further configuration can be chained. </returns>
        public static DbContextOptionsBuilder<TContext> UseSqliteWithIgnoredAmbientTransaction<TContext>(
            [NotNull] this DbContextOptionsBuilder<TContext> optionsBuilder,
            [NotNull] string connectionString,
            [CanBeNull] Action<SqliteDbContextOptionsBuilder> sqliteOptionsAction = null)
            where TContext : DbContext
            => (DbContextOptionsBuilder<TContext>)UseSqliteWithIgnoredAmbientTransaction(
