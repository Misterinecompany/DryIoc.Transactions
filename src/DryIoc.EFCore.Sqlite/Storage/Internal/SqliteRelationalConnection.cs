...
using DryIoc.EFCore.Sqlite.SQLite;
...
namespace DryIoc.EFCore.Sqlite.Storage.Internal
{
    /// <summary>
    ...
    public class SqliteRelationalConnection : RelationalConnection, ISqliteRelationalConnection
    {
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        protected override DbConnection CreateDbConnection() => new NewSqliteConnection(ConnectionString);
	    ...
	    protected override bool SupportsAmbientTransactions => true; // The ambient transactions are ignored. If True is not specified then EFCore throws exception on existing ambient transaction.
